...
где $\mathbf{r}_i$ — вектор взаимодействий с предметом i, $\mathbf{R}_{-i}$ — матрица взаимодействий без столбца i, $\lambda_1$ и $\lambda_2$ — коэффициенты L1 и L2 регуляризации.
