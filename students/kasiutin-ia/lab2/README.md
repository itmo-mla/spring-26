...
|---|---:|---:|---:|---:|---:|---:|
| Собственная реализация Random Forest | 0.8568 | 0.8584 | 0.8471 | 0.7800 | 0.5128 | 68.5 |
| `RandomForestClassifier` (`sklearn`) | 0.8555 | 0.8579 | 0.8471 | 0.7735 | 0.5180 | 31.4 |

Матрицы ошибок из ноутбука:

- Собственная реализация: `[[21142, 922], [3106, 3269]]`
- `sklearn`: `[[21097, 967], [3073, 3302]]`

- **По качеству:** обе реализации показывают практически одинквовое качество - следствие того, что самописный алгоритм работает по схожему принципу, что и `sklearn`.
- **По времени обучения:** на одинаковых параметрах эталонная реализация обучается быстрее, чем собственная реализация.
- **По важности признаков:** обе реализации выделяют схожий набор метеорологических факторов, но ранжирование немного отличается из-за разных способов оценки важности.
