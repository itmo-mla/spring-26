...
Sklearn работает быстрее в ~2.5× за счёт оптимизированного C-кода, однако Custom RF превосходит его по качеству. OOB-оценка оказалась близка к тестовой точности (0.8844 vs 0.8784), что подтверждает её надёжность как несмещённой оценки ошибки.
