...
class DecisionTree:
    ...
    def __init__(self, max_depth=None, min_samples_split=5, max_features=None):
    ...
    def predict_proba(self, X):
        return np.array([self._predict_proba(x, self.tree_) for x in X])
    ...
    def _predict_proba(self, inputs, node):
        ...
        return node.q_left * left_probs + node.q_right * right_probs